...
% %イオン温度
% errorbar(mpoints_1.r(r_list),T_i_mean_1(r_list,1),T_i_sigma_1(r_list,1),'LineWidth',2)%イオン温度
...
% unit = 1E2;
% grid2D.rq(1,:) = [];
% errorbar(grid2D.rq(:,1)*unit,diff_magpres_mean(:,1),diff_magpres_sigma(:,1),'LineWidth',2)%磁気圧
...
% %磁気圧(Bt)
% unit = 1E2;
% errorbar(grid2D.rq(:,1)*unit,magpres_t_mean(:,1),magpres_t_sigma(:,1),'LineWidth',2)%磁気圧
% ylabel('Magneic Pressure [Pa]')
...
%磁気圧(プラズマBt)
unit = 1E2;
errorbar(grid2D.rq(:,1)*unit,magpres_tp_mean(:,1),magpres_tp_sigma(:,1),'LineWidth',2)%磁気圧
ylabel('Magneic Pressure [Pa]')
...
% %磁気圧(Bz)
% unit = 1E2;
% errorbar(grid2D.rq(:,1)*unit,magpres_z_mean(:,1),magpres_z_sigma(:,1),'LineWidth',2)%磁気圧
% ylabel('Magneic Pressure [Pa]')
