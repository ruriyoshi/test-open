...
%[low_n_data,TF_low_n_data] = low_n_mode(date,shot,TF_shot,offset_TF);
...
%plot_psi_multi(B_z,r_probe,z_probe,461:1:480,true,true,true,false,shot,true,5);

% parameters:(B_z,r_probe,z_probe,t,fitting,fill,fixed_Clayer,show_probe,show_xpoint)
% plot_psi_at_t(B_z,r_probe,z_probe,475,true,true,true,true,true);
% parameters(B_z,r_probe,z_probe,ttime,fitting,fixed_Clayer,show_probe)
%plot_Et_and_psi_at_t(B_z,r_probe,z_probe,480,true,true,false,shot);
%[Et_x_point] = plot_Et_in_time_at_x_point(B_z,r_probe,450,480,shot);
