...
for i=1:n_data
    ...
    %plot_psi200ch_xpoint(date, dtacq_num, shot, tfshot,pathname,n,i_EF,trange,TF);
end
...
%size(A,dim)：行列Aの次元dimの長さ
%size(data2D.psi) : 60*60*201 (x,y,z)=(z,r,t)
data2D=struct(...
