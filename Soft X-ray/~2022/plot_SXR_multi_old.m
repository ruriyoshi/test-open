function [] = plot_SXR_multi_old(B_z,r_probe,z_probe,date,shot,show_xpoint,show_localmax,start,interval,save,SXRfilename,filter,NL)
...
%         再構成結果を保存するファイルを作成、保存
    ...
    plot_save_SXR_old(B_z,r_probe,z_probe,range,date,shot,t,EE_high,EE_low,show_localmax,show_xpoint,save,filter,NL);
