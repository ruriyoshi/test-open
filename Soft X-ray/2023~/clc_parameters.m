...
% ピンホールの位置とTS6の図面に沿って視線行列を計算する，X線コード群の中でも特にすげえ関数です．
% 計算した視線行列は，特異値分解したあとfilepath.matファイルに保存します．
...
l1 = MCPLine(N_projection,zhole1,false);
gm2d1 = LineProjection(l1,N_grid,zmin1,zmax1,rmin,rmax,false);
l2 = MCPLine(N_projection,zhole2,false);
