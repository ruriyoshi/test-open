...
function [] = main_ionflow_pcb200ch_auto(show_offset,plot_fit,save_flow,plot_psi,plot_flow,overlay_plot,save_fig)
%分光offsetを表示/ガウスフィッティングを表示/流速データを保存/磁気面をプロット/流速をプロット/流速と磁気面を重ねる/流速figを保存
%全てtrue or false
%実行例)main_ionflow_pcb200ch_auto(false,false,false,true,true,true,false)
...
end_cal = 4;%【input】磁気面&フロー計算終わりshot番号(実験ログD列)(0にするとbegin_cal以降の同日の全shot計算)
