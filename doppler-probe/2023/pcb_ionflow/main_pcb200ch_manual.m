...
%------【input】-------
date = 230524;%【input】実験日(yymmdd)
shotlist=1494;%991:992;%【input】dtacqの保存番号
tfshotlist=1444;%【input】dtacqのtfonly保存番号
EFlist = 150;%150;%【input】EF電流
n_plot = 4;%【input】磁気面subplot枚数(16以下の4の倍数or3以下)
t_start = 480;%【input】磁気面subplot開始時間(us)
dt = 2;%【input】磁気面subplot時間間隔(us)
cmap = false;%【input】磁気面カラーマップ('psi','Bz','Bt','Jt','Et',false)
cbar = true;%【input】カラーバー(true,false)

cal_pcb = false;%【input】磁場データを計算(true,false)
