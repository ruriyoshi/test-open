...
function [] = main_ionflow_manual(show_offset,plot_fit,plot_flow,save_flow,save_fig)
%offsetを表示/ガウスフィッティングを表示/流速をプロット/流速データを保存/流速figを保存
%全てtrue or false
...
shot = 3;%【input】ショット番号
trg = 474;%【input】ICCDトリガ時間
exp_w = 2;%【input】ICCD露光時間
gain = 4095;%【input】Andor gain
...
if save_flow
    ...
    save(['ionflow_mat/',num2str(time),'us_shot',num2str(shot),'.mat'],'V','Ti')
end
