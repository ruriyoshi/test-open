if nz == 1
    if t == 466
        ICCD_file1 = '/Volumes/experiment/results/Doppler/Andor/IDSP/230127/shot74_462us_w=3_gain=3900.asc';%ICCDファイル名
        ICCD_file2 = '/Volumes/experiment/results/Doppler/Andor/IDSP/230127/shot75_462us_w=3_gain=3900.asc';%ICCDファイル名
        ICCD_file3 = '';%ICCDファイル名
...
%         ICCD_file5 = '/Users/itsuki/Documents/東大/研究資料/Doppler_probe_data/230127/shot24_474us_w=3_gain=4095_PF20.asc';%ICCDファイル名
    ...
    if t == 470
        ICCD_file1 = '/Volumes/experiment/results/Doppler/Andor/IDSP/230127/shot71_466us_w=3_gain=3900.asc';%ICCDファイル名
        ICCD_file2 = '/Volumes/experiment/results/Doppler/Andor/IDSP/230127/shot72_466us_w=3_gain=3900.asc';%ICCDファイル名
        ICCD_file3 = '/Volumes/experiment/results/Doppler/Andor/IDSP/230127/shot73_466us_w=3_gain=3900.asc';%ICCDファイル名
%         ICCD_file4 = '/Users/itsuki/Documents/東大/研究資料/Doppler_probe_data/230127/shot24_474us_w=3_gain=4095_PF20.asc';%ICCDファイル名
%         ICCD_file5 = '/Users/itsuki/Documents/東大/研究資料/Doppler_probe_data/230127/shot24_474us_w=3_gain=4095_PF20.asc';%ICCDファイル名
    end
    if t == 474
        ICCD_file1 = '/Volumes/experiment/results/Doppler/Andor/IDSP/230127/shot68_470us_w=3_gain=4095.asc';%ICCDファイル名
        ICCD_file2 = '/Volumes/experiment/results/Doppler/Andor/IDSP/230127/shot69_470us_w=3_gain=4095.asc';%ICCDファイル名
        ICCD_file3 = '/Volumes/experiment/results/Doppler/Andor/IDSP/230127/shot70_470us_w=3_gain=3900.asc';%ICCDファイル名
...
%         ICCD_file5 = '/Users/itsuki/Documents/東大/研究資料/Doppler_probe_data/230127/shot30_474us_w=3_gain=4000_PF25.asc';%ICCDファイル名
    ...
    if t == 478
        ICCD_file1 = '/Volumes/experiment/results/Doppler/Andor/IDSP/230127/shot44_474us_w=3_gain=4095_PF39.asc';%ICCDファイル名
        ICCD_file2 = '/Volumes/experiment/results/Doppler/Andor/IDSP/230127/shot45_474us_w=3_gain=4095_PF39.asc';%ICCDファイル名
        ICCD_file3 = '/Volumes/experiment/results/Doppler/Andor/IDSP/230127/shot46_474us_w=3_gain=4095_PF39.asc';%ICCDファイル名
%         ICCD_file4 = '/Volumes/experiment/results/Doppler/Andor/IDSP/230127/shot47_474us_w=3_gain=4095_PF39.asc';%ICCDファイル名
%         ICCD_file5 = '/Volumes/experiment/results/Doppler/Andor/IDSP/230127/shot48_474us_w=3_gain=4095_PF39.asc';%ICCDファイル名
    end
    if t == 482
        ICCD_file1 = '/Volumes/experiment/results/Doppler/Andor/IDSP/230127/shot44_474us_w=3_gain=4095_PF39.asc';%ICCDファイル名
        ICCD_file2 = '/Volumes/experiment/results/Doppler/Andor/IDSP/230127/shot45_474us_w=3_gain=4095_PF39.asc';%ICCDファイル名
