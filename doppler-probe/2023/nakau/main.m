...
% z_measured(:,1) = [-0.3 -0.3 -0.3 -0.3 -0.3 -0.3 -0.3 -0.3 0 0 0 0 0 0 0 0 0.3 0.3 0.3 0.3 0.3 0.3 0.3 0.3];%data1のz座標
...
% filename1 = '/Users/itsuki/Documents/東大/研究資料/Doppler_probe_data/221220/shot5_474us_w=2_gain=3900.asc';%data1ファイル名
% filename1 = '/Users/itsuki/Documents/東大/研究資料/Doppler_probe_data/221220/shot33_474us_w=2_gain=4095_30kV.asc';%data1ファイル名
% filename1 = '/Users/itsuki/Documents/東大/研究資料/Doppler_probe_data/221220/shot53_474us_w=2_gain=3900_TF3.4kV.asc';%data1ファイル名
% filename1 = '/Users/itsuki/Documents/東大/研究資料/Doppler_probe_data/230118/shot14_478us_w=3_gain=3900.asc';%data1ファイル名
% filename1 = '/Volumes/experiment/results/Doppler/Andor/IDSP/230127/shot69_470us_w=3_gain=4095.asc';%data1ファイル名
...
if gas == 1
    %アルゴンの時
%         center_file = '221114_Xe_96120_calibration.txt';%中心データファイル名%96ch用
%     if NofCH == 32
%         center_file = 'calibation_32ch_230118.txt';%中心データファイル名
%         center_file = 'calibation_32ch_230127.txt';%中心データファイル名
%         center_file = 'calibation_32ch_221216.txt';%中心データファイル名
