if nz == 1
    if t == 466
        ICCD_file1 = '/Volumes/experiment/results/Doppler/Andor/IDSP/221104/shot13_466us_w=2_gain=3200.asc';%ICCDファイル名
        ICCD_file2 = '/Volumes/experiment/results/Doppler/Andor/IDSP/221104/shot14_466us_w=2_gain=3200.asc';%ICCDファイル名
        ICCD_file3 = '/Volumes/experiment/results/Doppler/Andor/IDSP/221104/shot6_474us_w=2_gain=3100.asc';%ICCDファイル名
        ICCD_file4 = '';%ICCDファイル名
        ICCD_file5 = '';%ICCDファイル名
    end
    if t == 470
        ICCD_file1 = '/Volumes/experiment/results/Doppler/Andor/IDSP/221104/shot9_470us_w=2_gain=3200.asc';%ICCDファイル名
        ICCD_file2 = '/Volumes/experiment/results/Doppler/Andor/IDSP/221104/shot10_470us_w=2_gain=3200.asc';%ICCDファイル名
        ICCD_file3 = '/Volumes/experiment/results/Doppler/Andor/IDSP/221104/shot8_470us_w=2_gain=3200.asc';%ICCDファイル名
    ...
    if t == 474
        ICCD_file1 = '/Volumes/experiment/results/Doppler/Andor/IDSP/221104/shot4_474us_w=2_gain=3100.asc';%ICCDファイル名
        ICCD_file2 = '/Volumes/experiment/results/Doppler/Andor/IDSP/221104/shot5_474us_w=2_gain=3100.asc';%ICCDファイル名
        ICCD_file3 = '/Volumes/experiment/results/Doppler/Andor/IDSP/221104/shot6_474us_w=2_gain=3100.asc';%ICCDファイル名
