if nz == 1
    if t == 465
        ICCD_file1 = '/Volumes/experiment/results/Doppler/Andor/IDSP/221101/shot27_474_w=2_3200.asc';%ICCDファイル名
        ICCD_file2 = '/Volumes/experiment/results/Doppler/Andor/IDSP/221101/shot28_474_w=2_3200.asc';%ICCDファイル名
        ICCD_file3 = '/Volumes/experiment/results/Doppler/Andor/IDSP/221101/shot29_474_w=2_3200.asc';%ICCDファイル名
        ICCD_file4 = '';%ICCDファイル名
        ICCD_file5 = '';%ICCDファイル名
    end
    if t == 467
        ICCD_file1 = '/Volumes/experiment/results/Doppler/Andor/IDSP/221101/shot26_474_w=2_3500.asc';%ICCDファイル名
