...
for i =10707%[1336,1337,1338,1344, 1345, 1352]%[1333,1336:1340,1342:1345,1346:1348,1350,1352]%[938,940,941,952,953,955]
    load(strcat('C:\Users\uswk0\OneDrive - g.ecc.u-tokyo.ac.jp\data\before_picture\a038_',num2str(i),'.mat'));
    ...
    saveas(gcf,strcat('C:\Users\uswk0\OneDrive - g.ecc.u-tokyo.ac.jp\data\picture\a038_',num2str(i),'_homework.png'))
   
   
    %plot_merging_rate:合体率抵抗率時間発展描画コード
    %plot_merging_rate(psi_pr, fitrate, xJt, xEt, xeta,trange);
    %saveas(gcf,strcat('C:\Users\uswk0\OneDrive - g.ecc.u-tokyo.ac.jp\data\picture\a038_',num2str(i),'_fitrate_homework.png'))%
   %}
%%%%
