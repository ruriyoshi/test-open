...
% %直接入力の場合
dtacqlist=39;
shotlist=395;%240;%【input】dtacqの保存番号
tfshotlist=391;%0;
...
%  saveas(gcf,strcat('C:\Users\kuru1\OneDrive - g.ecc.u-tokyo.ac.jp\labo\experiment\230119\jt\a039_',num2str(shot),'_jt_TF',num2str(TF),'kV_t466us.png'))
%  close
end
