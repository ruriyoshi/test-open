...
for i=1:n_data
    ...
    i_EF=EFlist(i);
    TF=TFlist(i);
    [psi_pr,fitrate,xpos,xEt,xJt,xeta,Brec]=calc_fitrate(date, dtacq_num, shot, tfshot, pathname,n,i_EF,trange,TF); 
end
...
function [psi_pr,fitrate,xpos,xEt,xJt,xeta,Brec]=calc_fitrate(date, dtacq_num, shot, tfshot, pathname, n,i_EF,trange,TF)
